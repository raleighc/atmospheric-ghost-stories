...
(
    ...
    VALUES
        ...
        so much I can do around here these days. It’s been so long since I’ve had new company.", "Oh, calm down. My name is [ghost-name] and this is my home. Normally I would welcome visitors, please be kind and don’t make me change my mind."),
        ...
        sure to stay on their good side, or you won’t get the key so you can leave. Can you help?", "This is my home. Do not speak of it like that. I worked my whole life for this house. Are you going to help us or not?"),
    ...
    Primary Key
        ...
        VALUES
            ...
            fancy house."),
            ("Will you help me, friend? I think I'm trapped, and as much I think {{ghost-name1}} is a nice lady, this house isn't my own and I need to keep searching for gold.", "I'll mine your head for gold, {{user-name}}!!!");